...
<div className="vy-note mt-8 max-w-3xl">
  <p className="italic">"With tools like VerifyYou, AI becomes a force for good. It helps prevent AI-driven fraud and can be done with much lower friction than what we built over the years."</p>
  <p className="mt-2 text-sm">Wes Michael, Founder and President, Rare Patient Voice</p>
</div>
...
<div className="vy-noprint mt-8 flex flex-wrap gap-3">
  ...
  <a href="https://sales.verifyyou.com/" className="vy-btn vy-btn-secondary"><Icon icon="calendar-check" iconType="light" size={15} /> Book time at the show</a>
</div>
