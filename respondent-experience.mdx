...
<Steps>
  <Step title="They click your study link">
    ...
    <Frame caption="Real product. 'Prove you're real. A quick face check before you continue.' One tap.">
      <img className="vy-phone" src="/images/screen-arrive-v2.png" alt="The handoff screen" style={{ maxWidth: '300px' }} />
    </Frame>
  </Step>
  <Step title="They do the scan">
    ...
    <Frame caption="Real product. Live prompts guide them: 'Hold still.'">
      <img className="vy-phone" src="/images/screen-scan2-v2.png" alt="The face scan" style={{ maxWidth: '300px' }} />
    </Frame>
  </Step>
  <Step title="The fork: pass or fail">
    ...
    <div className="grid md:grid-cols-2 gap-5 mt-6">
      <div className="border border-gray-200 dark:border-zinc-800 rounded-xl p-6 bg-gray-50 dark:bg-zinc-900">
        ...
        <img className="vy-phone mt-4" src="/images/screen-pass-2-v2.png" alt="The success screen" style={{ maxWidth: 'min(260px, 100%)', margin: '1rem auto 0', display: 'block' }} />
        ...
        <img className="vy-phone mt-6" src="/images/screen-gate-v2.png" alt="Survey login page pre-filled" style={{ maxWidth: 'min(260px, 100%)', margin: '1.5rem auto 0', display: 'block' }} />
      ...
      <div className="border border-gray-200 dark:border-zinc-800 rounded-xl p-6 bg-gray-50 dark:bg-zinc-900">
        ...
        <img className="vy-phone mt-4" src="/images/screen-denied-v2.png" alt="Denied screen" style={{ maxWidth: 'min(260px, 100%)', margin: '1rem auto 0', display: 'block' }} />
