...
A named market-research founder on why fraud is inevitable once money is involved, and why a real verification changes the game. The clips are muted by default, so tap to play with sound.

<div className="grid md:grid-cols-2 gap-5 mt-4">
  <div>
    <div className="vy-video"><video src="/videos/wes-half-worm.mp4" poster="/images/wes-michael.jpg" muted playsInline controls preload="metadata"></video></div>
    <p className="vy-caption">The half a worm: the fraud you do not catch until a decision has already been made on the data.</p>
  </div>
  <div>
    <div className="vy-video"><video src="/videos/wes-ballgame.mp4" poster="/images/wes-michael.jpg" muted playsInline controls preload="metadata"></video></div>
